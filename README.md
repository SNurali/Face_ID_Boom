...
Система распознавания лиц нового поколения — **JPG-Style Production**  
...
Работает:
- Регистрация пользователя с фото
- Извлечение эмбеддинга с quality gates
- Сохранение кропа лица на диск
- Логика выбора лучшего фото
- Инфраструктура: ClickHouse + Qdrant в docker-compose

В процессе:
- Сохранение эмбеддингов в БД
- Эндпоинт поиска по фото
